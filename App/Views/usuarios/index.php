    ...
    <div class="container" style="font-family: 'Questrial', sans-serif;"><br>
        ...
        <div class="row">
            ...
            <div class="col-sm-5 text-right">
                <button type="button" style="background-color: #5DADE2;"  data-toggle="modal" data-target=".bd-example-modal-lg" class="btn btn-sm text-white"><img src="<?=$baseUrl?>img/mas.png" width="14px" alt=""> Agregar Usuario</button>
            </div>
        </div><hr>
        <div class="row">
            <div class="col-sm-6 col-md-3"><br>   
                <div class="card rounded-0 text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><img class="rounded-circle" src="<?=$baseUrl?>img/medico1.png" width="120px" height="120px" alt=""></h5>
                        <span class="card-text">
                            <b>Rd. ENRIQUE SOTO QUISPE MENDOZA</b> <br>
                            <span class="text-muted"><b>ENRIQUE</b><br></span>
                            RADIOLOGIA<br>
                            <span class="badge text-white badge-pill" style="background-color: #6B6694;">Mi Perfil</span><br><br>
                            <button type="button" data-toggle="modal" data-target=".bd" class="btn-sm btn btn-info rounded-0">Editar</button>
                            <button type="button" class="btn-sm btn rounded-0" style="background-color: #566573;"><a href="#!" class="text-decoration-none text-white"  data-toggle="modal" data-target=".firmas">Firma</a></button><br>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-3"><br>   
                <div class="card rounded-0 text-center">
                    <div class="card-body">
                        <span><b>SAN JUAN DE LURIGANCHO</b></span>
                        <h5 class="card-title"><img class="rounded-circle" src="<?=$baseUrl?>img/No.jpg" width="120px" height="120px" alt=""></h5>
                        <span class="card-text">
                        <b>Rd. MARIA ATAUCCANCHA HUILCAS</b> <br>
                            <span class="text-muted"><b>MARIA</b><br></span>
                            Radiologo <br>
                            <span class="badge badge-pill badge-success">Activo</span><br><br>
                            <button type="button" data-toggle="modal" data-target=".bd" class="btn-sm btn btn-info rounded-0">Editar</button>
                            <button type="button" class="btn-sm btn rounded-0" style="background-color: #566573;"><a href="#!" class="text-decoration-none text-white"  data-toggle="modal" data-target=".firmas">Firma</a></button><br>
            ...
            <div class="col-sm-6 col-md-3"><br>   
                <div class="card rounded-0 text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><img class="rounded-circle" src="<?=$baseUrl?>img/perfil.jpg" width="120px" height="120px" alt=""></h5>
                        <p class="card-text">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label for="">DNI</label>
                            <input class="form-control border border-info" type="text">
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label border border-info" for="customFileLang">Seleccionar Archivo</label>
                            </div>
                        </div>
                    </div>
                    <div class="text-right"><br>
                        <button type="button" id="guardar" class="btn btn-sm btn-success">Guardar</button>
        ...
        <div class="modal-dialog modal-lg" style="font-family: 'Questrial', sans-serif;">
            <div style="background-color: #fafafa" class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <button type="button" value="Reset" id='resetSign' class="btn btn-sm text-white" style="background-color: #D35400;">Limpiar</button>
                </div>
            </div>
        </div>
    </div>
